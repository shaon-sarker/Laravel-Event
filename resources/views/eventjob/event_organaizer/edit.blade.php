                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="post" action="{{ route('eventorganaizer.update',$event_mans->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="" class="text-dark">Name</label>
                                    <input type="text" class="form-control input-rounded" name="name" placeholder="Name" required autofocus autocomplete="name" value="{{ $event_mans->name }}">
                                </div>
                                <div class="form-group">
                                    <label for="" class="text-dark">Email</label>
                                    <input type="email" class="form-control input-rounded" name="email" placeholder="Email" required autocomplete="username" value="{{ $event_mans->email }}">
                                </div>
                                <div class="form-group">
